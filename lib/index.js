...
// proto
const ConfigProto = loadProto('tensorflow/core/protobuf/config', 'ConfigProto');
const OpListProto = loadProto('tensorflow/core/framework/op_def', 'OpList');
// load modules
 ...
 */
 ...
 tensorflow.getAllOpList = function() {
   const opList = OpListProto.decode(new Graph().getAllOpList());
   return opList.op;
 }